...
def ascii_vro():
    clear()
    print(f'''
    Trời Ơi Tui Yêu Xnhiicuti Wáoo
    ''')
    time.sleep(0.6)
    clear()
    print(f'''
...
bots = len(proxys)
def si():
    print('\x1b[38;2;255;20;147mWelcome to Ddos \x1b[38;2;233;233;233mBy Merech Proxy')
    print("")
def title():
    clear()
    si()
    print(f'''      
            ...
            \x1b[38;2;0;255;255m╚═══════════════════╦══════════\x1b[38;2;255;20;147m═════════╦═══════════════════╝
                \x1b[38;2;0;255;255m╔═══════════════╩══════════\x1b[38;2;255;20;147m═════════╩═══════════════╗
                       No Spam Methods To Avoid Tool  Index Error 
                                     ''')
def main():
    title()
    while(True):
        cnc = input('''\x1bMerechProxy:''')
